"""
Automated Pytest for ecg-qtc-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    Continuous12leadEcgWaveformStreamingWithRealtimeQtcMonitoringEngine,
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    FilesToCreatemodifyEngine,
    AcceptanceCriteriaEngine,
    PharmacogenomicWarfarinDosingIntegrationCyp2c9Vkorc1Engine,
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    EcgqtccalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = EcgqtccalculatorEnrichmentSuite()
